...
#define PROBES_LIST \
	...
	X(PROBE_NAME(pthread_attr_getstackaddr), "pthread_attr_getstackaddr") \
	X(PROBE_NAME(pthread_attr_setstackaddr), "pthread_attr_setstackaddr") \
...
struct feature_desc_t *thread_feature = &feature;
struct feature_desc_t *thread_feature_always = &feature_always;
