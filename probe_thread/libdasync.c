...
int __PROBE__pthread_mutex_init(pthread_mutex_t *mutex,
...
int __PROBE__pthread_mutex_destroy(pthread_mutex_t *mutex) {
...
int __PROBE__pthread_mutex_lock(pthread_mutex_t *mutex) {
	static int (*pthread_mutex_lockp)(pthread_mutex_t *mutex);
...
int __PROBE__pthread_mutex_timedlock(pthread_mutex_t *mutex,
...
int __PROBE__pthread_mutex_trylock(pthread_mutex_t *mutex) {
...
int __PROBE__pthread_mutex_unlock(pthread_mutex_t *mutex) {
	static int (*pthread_mutex_unlockp)(pthread_mutex_t *mutex);
...
int __PROBE__pthread_mutexattr_init(pthread_mutexattr_t *attr) {
...
int __PROBE__pthread_mutexattr_destroy(pthread_mutexattr_t *attr) {
...
int __PROBE__pthread_mutexattr_getprioceiling(const pthread_mutexattr_t *attr,
		int *prioceiling) {
...
int __PROBE__pthread_mutexattr_setprioceiling(pthread_mutexattr_t *attr,
		int prioceiling) {
...
int __PROBE__pthread_mutexattr_getprotocol(const pthread_mutexattr_t *attr,
		int *protocol) {
...
int __PROBE__pthread_mutexattr_setprotocol(pthread_mutexattr_t *attr,
		int protocol) {
...
int __PROBE__pthread_mutexattr_getpshared(const pthread_mutexattr_t *attr,
		int *pshared) {
...
int __PROBE__pthread_mutexattr_setpshared(pthread_mutexattr_t *attr,
		int pshared) {
...
int __PROBE__pthread_mutexattr_gettype(const pthread_mutexattr_t *attr, int *type) {
...
int __PROBE__pthread_mutexattr_settype(pthread_mutexattr_t *attr, int type) {
...
int __PROBE__pthread_cond_init(pthread_cond_t *cond, const pthread_condattr_t *attr) {
...
int __PROBE__pthread_cond_destroy(pthread_cond_t *cond) {
...
int __PROBE__pthread_cond_wait(pthread_cond_t *cond, pthread_mutex_t *mutex) {
...
int __PROBE__pthread_cond_timedwait(pthread_cond_t *cond, pthread_mutex_t *mutex,
...
int __PROBE__pthread_cond_signal(pthread_cond_t *cond) {
...
int __PROBE__pthread_cond_broadcast(pthread_cond_t *cond) {
