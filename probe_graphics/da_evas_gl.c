...
HANDLER_DEF(void , evas_gl_surface_destroy, Evas_GL *evas_gl, Evas_GL_Surface *surf)
{
...
HANDLER_WRAPPERS(void , evas_gl_surface_destroy, Evas_GL *, evas_gl, Evas_GL_Surface *, surf)

HANDLER_DEF(void , evas_gl_context_destroy, Evas_GL *evas_gl, Evas_GL_Context *ctx)
{
...
HANDLER_WRAPPERS(void , evas_gl_context_destroy, Evas_GL *, evas_gl, Evas_GL_Context *, ctx)
...
HANDLER_DEF(Evas_GL *, evas_gl_new, Evas *e)
{
	...
	AFTER('p', voidp_to_uint64(res), APITYPE_CONTEXT, call_type, caller, "", "p",
	      voidp_to_uint64(e));
	return res;
}
HANDLER_WRAPPERS(Evas_GL *, evas_gl_new, Evas *, e)

HANDLER_DEF(Evas_GL_Config *, evas_gl_config_new, void)
{
...
HANDLER_WRAPPERS(Evas_GL_Config *, evas_gl_config_new, void)

HANDLER_DEF(Evas_GL_Surface *, evas_gl_surface_create, Evas_GL *evas_gl, Evas_GL_Config *cfg, int w, int h)
{
	...
	AFTER('p', voidp_to_uint64(res), APITYPE_CONTEXT, call_type, caller, "", "ppdd",
	      voidp_to_uint64(evas_gl), voidp_to_uint64(cfg), w, h);
	return res;
}
HANDLER_WRAPPERS(Evas_GL_Surface *, evas_gl_surface_create, Evas_GL *, evas_gl, Evas_GL_Config *, cfg, int, w, int, h)

HANDLER_DEF(Evas_GL_Context *, evas_gl_context_create, Evas_GL *evas_gl, Evas_GL_Context *share_ctx)
{
	...
	AFTER('p', voidp_to_uint64(res), APITYPE_CONTEXT, call_type, caller, "", "pp",
	      voidp_to_uint64(evas_gl), voidp_to_uint64(share_ctx));
	return res;
}
HANDLER_WRAPPERS(Evas_GL_Context *, evas_gl_context_create, Evas_GL *, evas_gl, Evas_GL_Context *, share_ctx)

HANDLER_DEF(Eina_Bool, evas_gl_make_current, Evas_GL *evas_gl, Evas_GL_Surface *surf, Evas_GL_Context *ctx)
{
	...
	AFTER('b', res, APITYPE_CONTEXT, call_type, caller, "", "ppp",
	      voidp_to_uint64(evas_gl), voidp_to_uint64(surf), voidp_to_uint64(ctx));
	return res;
}
HANDLER_WRAPPERS(Eina_Bool, evas_gl_make_current, Evas_GL *, evas_gl, Evas_GL_Surface *, surf, Evas_GL_Context *, ctx)
...
HANDLER_DEF(const char *, evas_gl_string_query, Evas_GL *evas_gl, int name)
{
	...
	AFTER('s', res, APITYPE_CONTEXT, call_type, caller, "", "pd",
	      voidp_to_uint64(evas_gl), name);
	return res;
}
HANDLER_WRAPPERS(const char *, evas_gl_string_query, Evas_GL *, evas_gl, int, name)

HANDLER_DEF(Evas_GL_Func , evas_gl_proc_address_get, Evas_GL *evas_gl, const char *name)
{
	...
	AFTER('p', voidp_to_uint64(res), APITYPE_CONTEXT, call_type, caller, "", "ps",
	      voidp_to_uint64(evas_gl), name);
	return res;
}
HANDLER_WRAPPERS(Evas_GL_Func , evas_gl_proc_address_get, Evas_GL *, evas_gl, const char *, name)

HANDLER_DEF(Eina_Bool, evas_gl_native_surface_get, Evas_GL *evas_gl, Evas_GL_Surface *surf, Evas_Native_Surface *ns)
{
	typedef Eina_Bool(*methodType)(Evas_GL *evas_gl, Evas_GL_Surface *surf,
...
HANDLER_WRAPPERS(Eina_Bool, evas_gl_native_surface_get, Evas_GL *, evas_gl, Evas_GL_Surface *, surf, Evas_Native_Surface *, ns)
...
HANDLER_DEF(Evas_GL_API *, evas_gl_api_get, Evas_GL *evas_gl)
{
	...
	AFTER('p', res, APITYPE_CONTEXT, call_type, caller, "", "p",
	      voidp_to_uint64(evas_gl));
...
HANDLER_DEF(Evas_GL_API *, evas_gl_context_api_get, Evas_GL *evas_gl, Evas_GL_Context *ctx)
{
	...
	AFTER('p', res, APITYPE_CONTEXT, call_type, caller, "", "pp",
	      voidp_to_uint64(evas_gl), voidp_to_uint64(ctx));

	return res;
}
HANDLER_WRAPPERS(Evas_GL_API *, evas_gl_context_api_get, Evas_GL *, evas_gl, Evas_GL_Context *, ctx)
