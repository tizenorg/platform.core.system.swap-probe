...
{
	TYPEDEF(typedef GLenum (*methodType)(void));
	BEFORE(glGetError);
...
{
	TYPEDEF(typedef void (*methodType)(GLenum));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLuint));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLuint, const char *));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLuint));
	BEFORE(glBindBuffer);
...
{
	TYPEDEF(typedef void (*methodType)(GLclampf, GLclampf, GLclampf, GLclampf));
	BEFORE(glBlendColor);
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum));
...
void REAL_NAME(glBlendFuncSeparate)(GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha,
			 GLenum dstAlpha)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLenum, GLenum));
...
void REAL_NAME(glBufferData)(GLenum target, GLsizeiptr size, const GLvoid * data,
		  GLenum usage)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLsizeiptr, const GLvoid *, GLenum));
	BEFORE(glBufferData);
...
void REAL_NAME(glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size,
		     const GLvoid * data)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLintptr, GLsizeiptr,
				   const GLvoid *));
...
{
	TYPEDEF(typedef GLenum (*methodType)(GLenum));
...
{
	TYPEDEF(typedef void (*methodType)(GLbitfield));
	BEFORE(glClear);
...
{
	TYPEDEF(typedef void (*methodType)(GLclampf));
...
{
	TYPEDEF(typedef void (*methodType)(GLint));
...
void REAL_NAME(glColorMask)(GLboolean red, GLboolean green, GLboolean blue,
		 GLboolean alpha)
{
	TYPEDEF(typedef void (*methodType)(GLboolean, GLboolean, GLboolean, GLboolean));
	BEFORE(glColorMask);
...
{
	TYPEDEF(typedef void (*methodType)(GLuint));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLenum, GLsizei, GLsizei,
...
void REAL_NAME(glCompressedTexSubImage2D)(GLenum target, GLint level, GLint xoffset,
			       ...
			       const GLvoid * data)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLint, GLint, GLsizei,
...
void REAL_NAME(glCopyTexImage2D)(GLenum target, GLint level, GLenum internalformat,
		      ...
		      GLint border)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLenum, GLint, GLint,
...
void REAL_NAME(glCopyTexSubImage2D)(GLenum target, GLint level, GLint xoffset,
			 ...
			 GLsizei height)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLint, GLint, GLint, GLint,
				   GLsizei, GLsizei));
...
{
	TYPEDEF(typedef GLuint (*methodType)(void));
...
{
	TYPEDEF(typedef GLuint (*methodType)(GLenum));
...
{
	TYPEDEF(typedef void (*methodType)(GLsizei, const GLuint *));
...
{
	TYPEDEF(typedef void (*methodType)(GLboolean));
	BEFORE(glDepthMask);
...
{
	TYPEDEF(typedef void (*methodType)(GLclampf, GLclampf));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLsizei));
	BEFORE(glDrawArrays);
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLsizei, GLenum, const GLvoid *));
...
{
	TYPEDEF(typedef void (*methodType)(void));
	BEFORE(glFinish);
	CALL_ORIG(glFinish,);
	GL_GET_ERROR();
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLenum, GLuint));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLenum, GLuint, GLint));
...
{
	TYPEDEF(typedef void (*methodType)(GLsizei, GLuint *));
	char buf[128] = "";
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLboolean *));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLfloat *));
	BEFORE(glGetFloatv);
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLuint, GLsizei, GLsizei *, GLint *,
				   GLenum *, char *));
...
void REAL_NAME(glGetAttachedShaders)(GLuint program, GLsizei maxCount, GLsizei *count,
			  GLuint *shaders)
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLsizei, GLsizei *, GLuint *));
...
{
	TYPEDEF(typedef int (*methodType)(GLuint, const char*));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLint *));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLenum, GLint *));
...
void REAL_NAME(glGetProgramInfoLog)(GLuint program, GLsizei maxLength, GLsizei *length,
			 char *infoLog)
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLsizei, GLsizei *, char *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLenum, GLint *));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLint *, GLint *));
...
{
	TYPEDEF(typedef const GLubyte *(*methodType)(GLenum));
	BEFORE(glGetString);
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLfloat *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLuint, GLfloat *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLuint, GLint *));
...
{
	TYPEDEF(typedef GLint (*methodType)(GLuint, const char *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLenum, GLfloat *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLenum, GLvoid **));
...
{
	TYPEDEF(typedef GLboolean (*methodType)(GLuint));
	BEFORE(glIsBuffer);
...
{
	TYPEDEF(typedef GLboolean (*methodType)(GLenum));
	BEFORE(glIsEnabled);
...
{
	TYPEDEF(typedef void (*methodType)(GLfloat));
	BEFORE(glLineWidth);
...
{
	TYPEDEF(typedef void (*methodType)(GLfloat, GLfloat));
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLint, GLsizei, GLsizei, GLenum,
				   GLenum, GLvoid *));
	BEFORE(glReadPixels);
...
void REAL_NAME(glRenderbufferStorage)(GLenum target, GLenum internalformat, GLsizei width,
			   GLsizei height)
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLsizei, GLsizei));
...
{
	TYPEDEF(typedef void (*methodType)(GLclampf, GLboolean));
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLint, GLsizei, GLsizei));
	BEFORE(glScissor);
...
{
	TYPEDEF(typedef void (*methodType)(GLsizei, const GLuint *, GLenum,
				   const void *, GLsizei));
...
void REAL_NAME(glShaderSource)(GLuint shader, GLsizei count, const char **string,
		    const GLint *length)
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLsizei, const char **,
				   const GLint*));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLint));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLint, GLuint));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, GLenum));
	BEFORE(glStencilOp);
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLint, GLint, GLsizei, GLsizei,
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, const GLfloat *));
...
{
	TYPEDEF(typedef void (*methodType)(GLenum, GLenum, const GLint *));
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLfloat));
	BEFORE(glUniform1f);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLfloat, GLfloat));
	BEFORE(glUniform2f);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLfloat, GLfloat, GLfloat));
	BEFORE(glUniform3f);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLfloat, GLfloat, GLfloat, GLfloat));
	BEFORE(glUniform4f);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLsizei, const GLfloat *));
	BEFORE(glUniform1fv);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLint));
	BEFORE(glUniform1i);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLint, GLint));
	BEFORE(glUniform2i);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLint, GLint, GLint));
	BEFORE(glUniform3i);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLint, GLint, GLint, GLint));
	BEFORE(glUniform4i);
...
{
	TYPEDEF(typedef void (*methodType)(GLint, GLsizei, const GLint *));
	BEFORE(glUniform1iv);
...
void REAL_NAME(glUniformMatrix2fv)(GLint location, GLsizei count, GLboolean transpose,
			const GLfloat *value)
{
	TYPEDEF(typedef void (*methodType)(GLint, GLsizei, GLboolean, const GLfloat *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLfloat));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLfloat, GLfloat));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLfloat, GLfloat, GLfloat));
...
void REAL_NAME(glVertexAttrib4f)(GLuint index, GLfloat v0, GLfloat v1, GLfloat v2,
		      GLfloat v3)
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, const GLfloat *));
...
{
	TYPEDEF(typedef void (*methodType)(GLuint, GLint, GLenum, GLboolean, GLsizei,
				   const GLvoid *));
