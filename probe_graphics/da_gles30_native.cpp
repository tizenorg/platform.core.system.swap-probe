...
DECLAR(void, glVertexAttribI3i, GLuint index, GLint x, GLint y, GLint z)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddd", index, x, y, z);
}

DECLAR(void, glVertexAttribI4i, GLuint index, GLint x, GLint y, GLint z, GLint w)
{
	TYPEDEF(void (*methodType)(GLuint, GLint, GLint, GLint, GLint));
	BEFORE(glVertexAttribI4i);
	CALL_ORIG(glVertexAttribI4i, index, x, y, z, w);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddddd", index, x, y, z, w);
}
...
DECLAR(void, glUniformBlockBinding, GLuint program, GLuint UniformBlockIndex, GLuint uniformBlockBinding)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddd", program, UniformBlockIndex, uniformBlockBinding);
}
...
DECLAR(void, glVertexAttribI4ui, GLuint index, GLuint x, GLuint y, GLuint z, GLuint w)
{
...
DECLAR(void, glGetQueryObjectuiv, GLuint id, GLenum pname, GLuint *params)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dxp", id, pname, params);
}

DECLAR(void, glGetActiveUniformsiv, GLuint program, GLsizei uniformCount, const GLuint *uniformIndices, GLenum pname, GLint *params)
{
	TYPEDEF(void (*methodType)(GLuint, GLsizei, const GLuint *, GLenum, GLint *));
	BEFORE(glGetActiveUniformsiv);
	CALL_ORIG(glGetActiveUniformsiv, program, uniformCount, uniformIndices, pname, params);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddxp", program, uniformCount, uniformIndices, pname, params);
}
...
DECLAR(void, glVertexAttribIPointer, GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
	TYPEDEF(void (*methodType)(GLuint, GLint, GLenum, GLsizei, const GLvoid *));
	BEFORE(glVertexAttribI4bv);
	CALL_ORIG(glVertexAttribI4bv, index, size, type, stride, pointer);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddxdp", index, size, type, stride, pointer);
}
...
DECLAR(void, glGetVertexAttribIuiv, GLuint index, GLenum pname, GLuint *params)
{
	TYPEDEF(void (*methodType)(GLuint, GLenum, GLuint*));
	BEFORE(glGetVertexAttribIiv);
	CALL_ORIG(glGetVertexAttribIiv, index, pname, params);
...
DECLAR(void, glUniform2ui, GLint location, GLuint v0, GLuint v1)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddd", location, v0, v1);
}
...
DECLAR(void, glUniform3ui, GLint location, GLuint v0, GLuint v1, GLuint v2)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddd", location, v0, v1, v2);
}

DECLAR(void, glUniform4ui, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3)
{
	TYPEDEF(void (*methodType)(GLint, GLuint, GLuint, GLuint, GLuint));
	BEFORE(glUniform4ui);
	CALL_ORIG(glUniform4ui, location, v0, v1, v2, v3);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddddd", location, v0, v1, v2, v3);
}

DECLAR(void, glUniform2uiv, GLint location, GLsizei count, const GLuint *value)
{
	TYPEDEF(void (*methodType)(GLint, GLuint, const GLuint*));
	BEFORE(glUniform2uiv);
	CALL_ORIG(glUniform2uiv, location, count, value);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddp", location, count, value);
}

DECLAR(void, glUniform3uiv, GLint location, GLsizei count, const GLuint *value)
{
	TYPEDEF(void (*methodType)(GLint, GLuint, const GLuint*));
...
DECLAR(void, glUniform1uiv, GLint location, GLsizei count, const GLuint *value)
{
	TYPEDEF(void (*methodType)(GLint, GLuint, const GLuint*));
...
DECLAR(void, glUniform4uiv, GLint location, GLsizei count, const GLuint *value)
{
	TYPEDEF(void (*methodType)(GLint, GLuint, const GLuint*));
...
DECLAR(void, glGetUniformuiv, GLuint program, GLint location, GLuint *params)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddp", program, location, params);
}

DECLAR(void, glBindFragDataLocation, GLuint program, GLuint colorNumber, const GLchar *name)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddp", program, colorNumber, name);
}
...
DECLAR(void, glGetFragDataLocation, GLuint program, const GLchar *name)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ds", program, name);
}
...
DECLAR(void, glClampColorARB, GLenum target, GLenum clamp)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xx", target, clamp);
}

DECLAR(void, glRenderbufferStorageMultisample, GLenum target, GLsizei samplers, GLenum internalformat, GLsizei width, GLsizei height)
{
	TYPEDEF(void (*methodType)(GLenum, GLsizei, GLenum, GLsizei, GLsizei));
	BEFORE(glRenderbufferStorageMultisample);
	CALL_ORIG(glRenderbufferStorageMultisample, target, samplers, internalformat, width, height);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xdxdd", samplers, internalformat, width, height);
}

DECLAR(void, BlitFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1)
{
	TYPEDEF(void (*methodType)(GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint));
	BEFORE(BlitFramebuffer);
	CALL_ORIG(BlitFramebuffer, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddddddd", srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1);
}
...
DECLAR(void, glTexParameterIiv, GLenum target, GLenum pname, GLint *params)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xxp", target, pname, params);
}
...
DECLAR(void, glFramebufferTureLayer, GLenum target, GLenum attachment, GLuint ture, GLint level, GLint layer)
{
	TYPEDEF(void (*methodType)(GLenum, GLenum, GLuint, GLint, GLint));
	BEFORE(glFramebufferTureLayer);
	CALL_ORIG(glFramebufferTureLayer, target, attachment, ture, level, layer);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xxddd", target, attachment, ture, layer);
}

DECLAR(void, glColorMaskIndexed, GLuint buf, GLboolean r, GLboolean g, GLboolean b, GLboolean a)
{
	TYPEDEF(void (*methodType)(GLuint, GLboolean, GLboolean, GLboolean, GLboolean));
	BEFORE(glColorMaskIndexed);
	CALL_ORIG(glColorMaskIndexed, buf, r, g, b, a);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddd", buf, r, g, b, a);
}
...
DECLAR(void, glBindBufferRange, GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
	TYPEDEF(void (*methodType)(GLenum, GLuint, GLuint, GLintptr, GLsizeiptr));
	BEFORE(glBindBufferRange);
	CALL_ORIG(glBindBufferRange, target, index, buffer, offset, size);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xddpp", target, index, buffer, offset, size);
}

DECLAR(void, glBindBufferOffset, GLenum target, GLuint index, GLuint buffer, GLintptr offset)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xddp", target, index, buffer, offset);
}
...
DECLAR(void, glBindBufferBase, GLenum target, GLuint index, GLuint buffer)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xddp", target, index, buffer);
}
...
DECLAR(void, glTransformFeedbackVaryings, GLuint program, GLsizei count, const char **varyings, GLenum bufferMode)
{
	TYPEDEF(void (*methodType)(GLuint, GLsizei, const char **, GLenum));
	BEFORE(glTransformFeedbackVaryings);
	CALL_ORIG(glTransformFeedbackVaryings, program, count, varyings, bufferMode);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddpx", program, count, varyings, bufferMode);
}

DECLAR(void, glGetTransformFeedbackVarying, GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLsizei *size, GLenum *type, char *name)
{
	TYPEDEF(void (*methodType)(GLuint, GLuint, GLsizei, GLsizei *, GLsizei *, GLenum *, char *));
	BEFORE(glGetTransformFeedbackVarying);
	CALL_ORIG(glGetTransformFeedbackVarying, program, index, bufSize, length, size, type, name);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddppps", program, index, bufSize, length, size, type, name);
}

DECLAR(void, glFlushMappedBufferRange, GLenum target, GLintptr offset, GLsizeiptr length)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xpp", target, offset, length );
}
...
DECLAR(void, glCopyBufferSubData, GLenum readtarget,GLenum writetarget, GLintptr readoffset, GLintptr writeoffset, GLsizeiptr size)
{
	TYPEDEF(void (*methodType)(GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr));
	BEFORE(glCopyBufferSubData);
	CALL_ORIG(glCopyBufferSubData, readtarget, writetarget, readoffset, writeoffset, size);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xxppp", readtarget, writetarget, readoffset, writeoffset, size);
}
...
DECLAR(void, glGetProgramBinary, GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, void *binary)
{
	TYPEDEF(void (*methodType)(GLuint, GLsizei, GLsizei *, GLenum *, void *));
	BEFORE(glGetProgramBinary);
	CALL_ORIG(glGetProgramBinary, program, bufSize, length, binaryFormat, binary);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddppp", program, bufSize, length, binaryFormat, binary);
}

DECLAR(void, glProgramBinary, GLuint program, GLenum binaryFormat, const void *binary, GLsizei length)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dxp", program, binaryFormat, binary, length);
}

DECLAR(GLuint, glGetUniformBlockIndex, GLuint program, const GLchar *uniformBlockName)
{
	TYPEDEF(GLuint (*methodType)(GLuint, const GLchar *));
	BEFORE(glGetUniformBlockIndex);
	GLint ret = CALL_ORIG(glGetUniformBlockIndex, program, uniformBlockName);
	GL_GET_ERROR();
...
DECLAR(void, glGetActiveUniformBlockName, GLuint program, GLuint UniformBlockIndex, GLsizei bufSize, GLsizei *length, GLchar *uniformBlockName)
{
	TYPEDEF(void (*methodType)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *));
	BEFORE(glGetActiveUniformBlockName);
	CALL_ORIG(glGetActiveUniformBlockName, program, UniformBlockIndex, bufSize, length, uniformBlockName);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddxp", program, UniformBlockIndex, bufSize, length, uniformBlockName);
}

DECLAR(void, glGetActiveUniformBlockiv, GLuint program, GLuint UniformBlockIndex, GLenum pname, GLint *params)
{
	TYPEDEF(void (*methodType)(GLuint, GLuint, GLenum, GLint *));
	BEFORE(glGetActiveUniformBlockiv);
	CALL_ORIG(glGetActiveUniformBlockiv, program, UniformBlockIndex, pname, params);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddxp", program, UniformBlockIndex, pname, params);
}

DECLAR(void, glGetUniformIndices, GLuint program, GLsizei uniformCount, const GLchar **uniformsNames, GLuint *uniformIndices)
{
	TYPEDEF(void (*methodType)(GLuint, GLsizei, const GLchar **, GLuint *));
	BEFORE(glGetUniformIndices);
	CALL_ORIG(glGetUniformIndices, program, uniformCount, uniformsNames, uniformIndices);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "ddxpp", program, uniformCount, uniformsNames, uniformIndices);
}
...
DECLAR(void, glSamplerParameterf, GLuint sampler, GLenum pname, GLfloat param)
{
	...
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dxd", sampler, pname, param);
}
...
DECLAR(void, glSamplerParameterfv, GLuint sampler, GLenum pname, const GLfloat *params)
{
	TYPEDEF(void (*methodType)(GLuint, GLenum, const GLfloat *));
	BEFORE(glBindSampler);
	CALL_ORIG(glBindSampler, sampler, pname, params);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dxp", sampler, pname, params);
}

DECLAR(void, glSamplerParameteriv, GLuint sampler, GLenum pname, const GLint *params)
{
...
DECLAR(void, glSamplerParameterIiv, GLuint sampler, GLenum pname, const GLint *params)
{
	TYPEDEF(void (*methodType)(GLuint, GLenum, const GLint *));
...
DECLAR(void, glSamplerParameterIuiv, GLuint sampler, GLenum pname, const GLuint *params)
{
...
DECLAR(void, glTexImage3D, GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *data)
{
	TYPEDEF(void (*methodType)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid *));
	BEFORE(glDeleteSamplers);
	CALL_ORIG(glDeleteSamplers, target, level, internalFormat, width, height, depth, border, format, type, data);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xddddddxxp", target, level, internalFormat, width, height, depth, border, format, type, data);
}

DECLAR(void, glTexStorage2D, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height)
{
	TYPEDEF(void (*methodType)(GLenum, GLsizei, GLenum, GLsizei, GLsizei));
	BEFORE(glTexStorage2D);
	CALL_ORIG(glTexStorage2D, target, levels, internalformat, width, height);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xdxdd", target, levels, internalformat, width, height);
}

DECLAR(void, glTexSubImage3D, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels)
{
	TYPEDEF(void (*methodType)(GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const GLvoid *));
	BEFORE(glTexSubImage3D);
	CALL_ORIG(glTexSubImage3D, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddddddxxp", level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);
}

DECLAR(void, glCompressedTexImage3D, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data)
{
	TYPEDEF(void (*methodType)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *));
	BEFORE(glCompressedTexImage3D);
	CALL_ORIG(glCompressedTexImage3D, target, level, internalformat, width, height, depth, border, imageSize, data);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xdxdddddp", target, level, internalformat, width, height, depth, border, imageSize, data);
}

DECLAR(void, glCompressedTexSubImage3D, GLenum target, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLint height, GLint depth, GLenum format, GLsizei imageSize, const GLvoid *data)
{
	TYPEDEF(void (*methodType)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *));
	BEFORE(glCompressedTexSubImage3D);
	CALL_ORIG(glCompressedTexSubImage3D, target, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xdddddddxdp", target, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
}

DECLAR(void, glFramebufferTextureLayer, GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer)
{
	TYPEDEF(void (*methodType)(GLenum, GLenum, GLuint, GLint, GLint));
	BEFORE(glFramebufferTextureLayer);
	CALL_ORIG(glFramebufferTextureLayer, target, attachment, texture, level, layer);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xxddd", target, attachment, texture, level, layer);
}

DECLAR(void, glInvalidateFramebuffer, GLenum target, GLsizei numAttachments, const GLenum *attachments)
{
	TYPEDEF(void (*methodType)(GLenum, GLsizei, const GLenum *));
	BEFORE(glInvalidateFramebuffer);
	CALL_ORIG(glInvalidateFramebuffer, target, numAttachments, attachments);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xdp", target, numAttachments, attachments);
}

DECLAR(void, glInvalidateSubFramebuffer, GLenum target, GLsizei numAttachments, const GLenum *attachments, GLint x, GLint y, GLint width, GLsizei height)
{
	TYPEDEF(void (*methodType)(GLenum, GLsizei, const GLenum *, GLint, GLint, GLsizei, GLsizei));
	BEFORE(glInvalidateSubFramebuffer);
	CALL_ORIG(glInvalidateSubFramebuffer, target, numAttachments, attachments, x, y, width, height);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "xdpdddd", target, numAttachments, attachments, x, y, width, height);
}

DECLAR(void, glInvalidateTexSubImage, GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth)
{
	TYPEDEF(void (*methodType)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei));
	BEFORE(glInvalidateTexSubImage);
	CALL_ORIG(glInvalidateTexSubImage, texture, level, xoffset, yoffset, zoffset, width, height, depth);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dddddddd", texture, level, xoffset, yoffset, zoffset, width, height, depth);
}
...
DECLAR(void, glInvalidateBufferSubData, GLuint buffer, GLintptr offset, GLsizeiptr length)
{
	TYPEDEF(void (*methodType)(GLuint, GLintptr, GLsizeiptr));
	BEFORE(glInvalidateTexImage);
	CALL_ORIG(glInvalidateTexImage, buffer, offset, length);
	GL_GET_ERROR();
	AFTER('v', NO_RETURN_VALUE, APITYPE_CONTEXT, "", "dxx", buffer, offset, length);
}
