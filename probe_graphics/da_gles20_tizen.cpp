...
#define DECLARE(TYPE, FUNCNAME, ...)   HANDLER_WRAPPERS(TYPE, REAL_NAME(FUNCNAME), __VA_ARGS__)
#define DECLARE_NOARGS(TYPE, FUNCNAME)   HANDLER_WRAPPERS(TYPE, REAL_NAME(FUNCNAME))
