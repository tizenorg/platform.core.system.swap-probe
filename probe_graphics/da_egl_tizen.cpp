...
HANDLER_WRAPPERS(graphics_feature, graphics, EGLint, eglGetError, void)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglInitialize, EGLDisplay, dpy, EGLint *, major,
		 EGLint *, minor)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglTerminate, EGLDisplay, dpy)
{
...
HANDLER_WRAPPERS(graphics_feature, const char *, eglQueryString, EGLDisplay, dpy, EGLint, name)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglGetConfigs, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglChooseConfig, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglGetConfigAttrib, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLSurface, eglCreateWindowSurface, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLSurface, eglCreatePixmapSurface, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglDestroySurface, EGLDisplay, dpy,
		 EGLSurface, surface)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglQuerySurface, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglBindAPI, EGLenum, api)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLenum, eglQueryAPI, void)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglWaitClient, void)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglReleaseThread, void)
{
	typedef EGLBoolean (*methodType)(void);
	/* probe prepare */
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglSurfaceAttrib, EGLDisplay, dpy,
		 EGLSurface, surface, EGLint, attribute, EGLint, value)
{
	typedef EGLBoolean (*methodType)(EGLDisplay dpy, EGLSurface surface,
					 EGLint attribute, EGLint value);
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglBindTexImage, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglReleaseTexImage, EGLDisplay, dpy,
		 EGLSurface, surface, EGLint, buffer)
{
	typedef EGLBoolean (*methodType)(EGLDisplay dpy, EGLSurface surface,
					 EGLint buffer);
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglSwapInterval, EGLDisplay, dpy, EGLint, interval)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLContext, eglCreateContext, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglDestroyContext, EGLDisplay, dpy,
		 EGLContext, ctx)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglMakeCurrent, EGLDisplay, dpy, EGLSurface, draw,
...
HANDLER_WRAPPERS(graphics_feature, EGLContext, eglGetCurrentContext, void)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLSurface, eglGetCurrentSurface, EGLint, readdraw)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLDisplay, eglGetCurrentDisplay, void)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglWaitGL, void)
{
	typedef EGLBoolean (*methodType)(void);
	/* probe prepare */
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglWaitNative, EGLint, engine)
{
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglSwapBuffers, EGLDisplay, dpy,
		 EGLSurface, surface)
{
	typedef EGLBoolean (*methodType)(EGLDisplay dpy, EGLSurface surface);
...
HANDLER_WRAPPERS(graphics_feature, EGLBoolean, eglCopyBuffers, EGLDisplay, dpy,
...
HANDLER_WRAPPERS(graphics_feature, EGLAPI __eglGetProcAddress_t, eglGetProcAddress,
		 const char *, procname)
{
