...
HANDLER_DEF(int, accept, int socket, struct sockaddr *address, socklen_t *address_len)
{
...
HANDLER_WRAPPERS(int, accept, int, socket, struct sockaddr *, address, socklen_t *, address_len)

HANDLER_DEF(int, accept4, int sockfd, struct sockaddr *addr, socklen_t *addrlen, int flags)
{
...
HANDLER_WRAPPERS(int, accept4, int, sockfd, struct sockaddr *, addr, socklen_t *, addrlen, int, flags)

HANDLER_DEF(int, connect, int socket, const struct sockaddr *address, socklen_t address_len)
{
...
HANDLER_WRAPPERS(int, connect, int, socket, const struct sockaddr *, address, socklen_t, address_len)
...
HANDLER_DEF(int, bind, int socket, const struct sockaddr *address, socklen_t address_len)
{
...
HANDLER_WRAPPERS(int, bind, int, socket, const struct sockaddr *, address, socklen_t, address_len)
...
HANDLER_DEF(ssize_t, send, int socket, const void *message, size_t length, int flags)
{
...
HANDLER_WRAPPERS(ssize_t, send, int, socket, const void *, message, size_t, length, int, flags)
...
HANDLER_WRAPPERS(ssize_t, recv, int, socket, void *, buffer, size_t, length, int, flags)

HANDLER_DEF(ssize_t, sendto, int socket, const void *message, size_t length, int flags, const struct sockaddr *dest_addr, socklen_t dest_len)
{
...
HANDLER_WRAPPERS(ssize_t, sendto, int, socket, const void *, message, size_t, length, int, flags, const struct sockaddr *, dest_addr, socklen_t, dest_len)

HANDLER_DEF(ssize_t, recvfrom, int socket, void *buffer, size_t length, int flags, struct sockaddr *address, socklen_t *address_len)
{
...
HANDLER_WRAPPERS(ssize_t, recvfrom, int, socket, void *, buffer, size_t, length, int, flags, struct sockaddr *, address, socklen_t *, address_len)
...
HANDLER_WRAPPERS(ssize_t, recvmsg, int, socket, struct msghdr *,message, int, flags)

HANDLER_DEF(ssize_t, sendmsg, int socket, const struct msghdr *message, int flags)
{
...
HANDLER_WRAPPERS(ssize_t, sendmsg, int, socket, const struct msghdr *, message, int, flags)

HANDLER_DEF(int, getsockopt, int socket, int level, int option_name, void *option_value, socklen_t *option_len)
{
...
HANDLER_WRAPPERS(int, getsockopt, int, socket, int, level, int, option_name, void *, option_value, socklen_t *, option_len)

HANDLER_DEF(int, setsockopt, int socket, int level, int option_name, const void *option_value, socklen_t option_len)
{
...
HANDLER_WRAPPERS(int, setsockopt, int, socket, int, level, int, option_name, const void *, option_value, socklen_t, option_len)
...
HANDLER_WRAPPERS(int, getpeername, int, fd, struct sockaddr *, addr, socklen_t *, len)

HANDLER_DEF(int, getsockname, int sockfd, struct sockaddr *addr, socklen_t *addrlen)
{
...
HANDLER_WRAPPERS(int, getsockname, int, sockfd, struct sockaddr *, addr, socklen_t *, addrlen)

HANDLER_DEF(int, socketpair, int domain, int type, int protocol, int socket_vector[2])
{
...
HANDLER_WRAPPERS(int, socketpair, int, domain, int, type, int, protocol, int *, socket_vector)
...
HANDLER_DEF(int, select, int nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, struct timeval *timeout)
{
...
HANDLER_WRAPPERS(int, select, int, nfds, fd_set *, readfds, fd_set *, writefds, fd_set *, exceptfds, struct timeval *, timeout)

HANDLER_DEF(int, pselect, int nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, const struct timespec *ntimeout, const sigset_t *sigmask)
{
...
HANDLER_WRAPPERS(int, pselect, int, nfds, fd_set *, readfds, fd_set *, writefds, fd_set *, exceptfds, const struct timespec *, ntimeout, const sigset_t *, sigmask)
...
HANDLER_DEF(int, ppoll, struct pollfd *fds, nfds_t nfds, const struct timespec *timeout_ts, const sigset_t *sigmask)
{
...
HANDLER_WRAPPERS(int, ppoll, struct pollfd *, fds, nfds_t, nfds, const struct timespec *, timeout_ts, const sigset_t *,sigmask)
...
HANDLER_DEF(int, epoll_wait, int __epfd, struct epoll_event *__events, int __maxevents, int __timeout)
{
...
HANDLER_WRAPPERS(int, epoll_wait, int, __epfd, struct epoll_event *, __events, int, __maxevents, int, __timeout)

HANDLER_DEF(int, epoll_pwait, int __epfd, struct epoll_event *__events, int __maxevents, int __timeout, __const __sigset_t * __ss)
{
...
HANDLER_WRAPPERS(int, epoll_pwait, int, __epfd, struct epoll_event *, __events, int, __maxevents, int, __timeout, __const __sigset_t *, __ss)

HANDLER_DEF(int, epoll_ctl, int __epfd, int __op, int __fd, struct epoll_event *__event)
{
...
HANDLER_WRAPPERS(int, epoll_ctl, int, __epfd, int, __op, int, __fd, struct epoll_event *, __event)
...
HANDLER_DEF(const char *, inet_ntop, int af, const void *src, char *dst, socklen_t size)
{
...
HANDLER_WRAPPERS(const char *, inet_ntop, int, af, const void *, src, char *, dst, socklen_t, size)
...
HANDLER_DEF(int, getaddrinfo, const char *node, const char *service, const struct addrinfo *hints, struct addrinfo **res)
{
...
HANDLER_WRAPPERS(int, getaddrinfo, const char *, node, const char *, service, const struct addrinfo *, hints, struct addrinfo **, res)
...
HANDLER_DEF(int, gai_suspend, const struct gaicb* const list[], int nitems, const struct timespec *timeout)
{
...
HANDLER_WRAPPERS(int, gai_suspend, const struct gaicb** const, list, int, nitems, const struct timespec *, timeout)
...
HANDLER_DEF(int, getaddrinfo_a, int mode, struct gaicb *list[], int nitems, struct sigevent *sevp)
{
...
HANDLER_WRAPPERS(int, getaddrinfo_a, int, mode, struct gaicb **, list, int, nitems, struct sigevent *, sevp)
...
HANDLER_DEF(int, getnameinfo, const struct sockaddr *sa, socklen_t salen, char *host, socklen_t hostlen, char *serv, socklen_t servlen, unsigned int flags)
{
...
HANDLER_WRAPPERS(int, getnameinfo, const struct sockaddr *, sa, socklen_t, salen, char *, host, socklen_t, hostlen, char *, serv, socklen_t, servlen, unsigned int, flags)
...
HANDLER_DEF(struct hostent *, gethostbyaddr, const void *addr, socklen_t len, int type)
{
...
HANDLER_WRAPPERS(struct hostent *, gethostbyaddr, const void *, addr, socklen_t, len, int, type)
...
HANDLER_DEF(int, gethostent_r, struct hostent *rret, char *buf, size_t buflen, struct hostent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, gethostent_r, struct hostent *, rret, char *, buf, size_t, buflen, struct hostent **, result, int *, h_errnop)

HANDLER_DEF(int, gethostbyaddr_r, const void *addr, socklen_t len, int type, struct hostent *rret, char *buf, size_t buflen, struct hostent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, gethostbyaddr_r, const void *, addr, socklen_t, len, int, type, struct hostent *, rret, char *, buf, size_t, buflen, struct hostent **, result, int *, h_errnop)

HANDLER_DEF(int, gethostbyname_r, const char *name, struct hostent *rret, char *buf, size_t buflen, struct hostent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, gethostbyname_r, const char *, name, struct hostent *, rret, char *, buf, size_t, buflen, struct hostent **, result, int *, h_errnop)

HANDLER_DEF(int, gethostbyname2_r, const char *name, int af, struct hostent *rret, char *buf, size_t buflen, struct hostent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, gethostbyname2_r, const char *, name, int, af, struct hostent *, rret, char *, buf, size_t, buflen, struct hostent **, result, int *, h_errnop)

HANDLER_DEF(struct servent *, getservbyname, const char *name, const char *proto)
{
...
HANDLER_WRAPPERS(struct servent *, getservbyname, const char *, name, const char *, proto)
...
HANDLER_WRAPPERS(struct servent *, getservbyport, int, port, const char *, proto)

HANDLED_DEF(int, getservent_r, struct servent *result_buf, char *buf, size_t buflen, struct servent **result)
{
...
HANDLED_WRAPPERS(int, getservent_r, struct servent *, result_buf, char *, buf, size_t, buflen, struct servent **, result)

HANDLER_DEF(int, getservbyname_r, const char *name, const char *proto, struct servent *result_buf, char *buf, size_t buflen, struct servent **result)
{
...
HANDLER_WRAPPERS(int, getservbyname_r, const char *, name, const char *, proto, struct servent *, result_buf, char *, buf, size_t, buflen, struct servent **, result)

HANDLER_DEF(int, getservbyport_r, int port, const char *proto, struct servent *result_buf, char *buf, size_t buflen, struct servent **result)
{
...
HANDLER_WRAPPERS(int, getservbyport_r, int, port, const char *, proto, struct servent *, result_buf, char *, buf, size_t, buflen, struct servent **, result)
...
HANDLER_DEF(int, getnetent_r, struct netent *result_buf, char *buf, size_t buflen, struct netent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, getnetent_r, struct netent *, result_buf, char *, buf, size_t, buflen, struct netent **, result, int *, h_errnop)

HANDLER_DEF(int, getnetbyname_r, const char *name, struct netent *result_buf, char *buf, size_t buflen, struct netent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, getnetbyname_r, const char *, name, struct netent *, result_buf, char *, buf, size_t, buflen, struct netent **, result, int *, h_errnop)

HANDLER_DEF(int, getnetbyaddr_r, uint32_t net, int type, struct netent *result_buf, char *buf, size_t buflen, struct netent **result, int *h_errnop)
{
...
HANDLER_WRAPPERS(int, getnetbyaddr_r, uint32_t, net, int, type, struct netent *, result_buf, char *, buf, size_t, buflen, struct netent **, result, int *, h_errnop)
...
HANDLER_DEF(int, getprotoent_r, struct protoent *result_buf, char *buf, size_t buflen, struct protoent **result)
{
...
HANDLER_WRAPPERS(int, getprotoent_r, struct protoent *, result_buf, char *, buf, size_t, buflen, struct protoent **, result)

HANDLER_DEF(int, getprotobyname_r, const char *name, struct protoent *result_buf, char *buf, size_t buflen, struct protoent **result)
{
...
HANDLER_WRAPPERS(int, getprotobyname_r, const char *, name, struct protoent *, result_buf, char *, buf, size_t, buflen, struct protoent **, result)

HANDLER_DEF(int, getprotobynumber_r, int proto, struct protoent *result_buf, char *buf, size_t buflen, struct protoent **result)
{
...
HANDLER_WRAPPERS(int, getprotobynumber_r, int, proto, struct protoent *, result_buf, char *, buf, size_t, buflen, struct protoent **, result)
...
HANDLER_WRAPPERS(char *, if_indextoname, unsigned int, __ifindex, char *, __ifname)
