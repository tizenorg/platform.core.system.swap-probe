...
//lib Common Function
#define AFTER_ORIGINAL_LIBC_SOCK(RTYPE, RVAL, OBJECTPTR, FDVALUE, APITYPE, CALL_TYPE, CALLER, TOTAL_INFO, INPUTFORMAT, ...)      \
...
//lib START Function
#define AFTER_ORIGINAL_LIBC_SOCK_WAIT_FUNC_START(RTYPE, RVAL,OBJECTPTR, FDVALUE, APITYPE, CALL_TYPE, CALLER, TOTAL_INFO, INPUTFORMAT, ...)	\
	POST_PROBEBLOCK_FUNC_START_BEGIN(LC_SOCKET, RTYPE, RVAL, CALL_TYPE, CALLER, INPUTFORMAT, __VA_ARGS__);				\
	POST_PROBEBLOCK_MIDDLE_LIBC_SOCK(OBJECTPTR, FDVALUE, APITYPE, TOTAL_INFO );					\
	FLUSH_LOCAL_BUF();												\
	POST_PROBEBLOCK_FUNC_START_END()

#define POST_PROBEBLOCK_FUNC_START_BEGIN(LCTYPE, RTYPE, RETVALUE, CALL_TYPE, CALLER, INPUTFORMAT, ...)	\
		newerrno = errno;														\
			do { \
				PREPARE_LOCAL_BUF(); \
...
//lib END Function
#define AFTER_ORIGINAL_LIBC_SOCK_WAIT_FUNC_END(RTYPE, RVAL, OBJECTPTR, FDVALUE, APITYPE, CALL_TYPE, CALLER, TOTAL_INFO, INPUTFORMAT, ...)	\
	POST_PROBEBLOCK_FUNC_END_BEGIN(LC_SOCKET, RTYPE, RVAL, CALL_TYPE, CALLER, INPUTFORMAT, __VA_ARGS__);		\
	POST_PROBEBLOCK_MIDDLE_LIBC_SOCK(OBJECTPTR, FDVALUE, APITYPE, TOTAL_INFO );								\
	POST_PROBEBLOCK_END()

#define POST_PROBEBLOCK_FUNC_END_BEGIN(LCTYPE, RTYPE, RETVALUE, CALL_TYPE, CALLER, INPUTFORMAT, ...)	\
	newerrno = errno;														\
	do {														\
