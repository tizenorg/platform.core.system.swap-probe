				    ...
				    void __attribute__((unused)) *data)
{
	...
	if (!rotation.auto_rotate)
		PRINTMSG("auto_rotate: %d, angle: %d",
				  ...
				  void __attribute__((unused)) *user_data)
{
	...
	PRINTMSG("angle: %d, auto_rotate %d",
			rotation.angle, rotation.auto_rotate);
	if (!rotation.auto_rotate)
		return;
...
static int __rotate_event_init(void)
{
	...
	PRINTMSG("initial value of auto_rotate %d", rotation.auto_rotate);
	...
	PRINTMSG("initial value of angle %d", rotation.angle);
