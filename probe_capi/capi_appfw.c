...
int __PROBE__app_efl_main(int *argc, char ***argv, app_event_callback_s *callback, void *user_data)
{
...
int __PROBE__ui_app_main(int argc, char **argv, ui_app_lifecycle_callback_s *callback, void *user_data)
{
