...
HANDLER_WRAPPERS(ssize_t, pread, int fd, void *buf, size_t nbyte, off_t offset)
...
HANDLER_DEF(ssize_t, pwrite, int fd, const void *buf, size_t nbyte, off_t offset)
{
...
HANDLER_WRAPPERS(ssize_t, pwrite, int fd, const void *buf, size_t nbyte, off_t offset)
...
HANDLER_WRAPPERS(int, futimens, int fd, const struct timespec times[2])
