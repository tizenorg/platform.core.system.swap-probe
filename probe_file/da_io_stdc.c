...
FILE* __PROBE__fopen(const char* filename, const char* mode)
{
...
FILE* __PROBE__freopen(const char * filename, const char * mode, FILE * stream)
{
...
FILE* __PROBE__fdopen(int fildes, const char *mode)
{
...
int __PROBE__fflush(FILE* stream)
{
...
int __PROBE__fclose(FILE* stream)
{
...
int __PROBE__fgetpos(FILE* stream, fpos_t* position)
{
...
int __PROBE__fseek(FILE* stream, long int offset, int origin)
{
...
int __PROBE__fsetpos(FILE* stream, const fpos_t* pos)
{
...
long int __PROBE__ftell(FILE* stream)
{
...
void __PROBE__rewind(FILE* stream)
{
...
void __PROBE__clearerr(FILE* stream)
{
...
int __PROBE__ferror(FILE* stream)
{
...
int __PROBE__fileno(FILE* stream)
{
...
int __PROBE__vfprintf(FILE* stream, const char* format, va_list arg)
{
...
int __PROBE__vfscanf(FILE* stream, const char* format, va_list arg)
{
...
int __PROBE__fgetc(FILE* stream)
{
...
char* __PROBE__fgets(char* str, int size, FILE* stream)
{
...
int __PROBE__fputc(int character, FILE* stream)
{
...
int __PROBE__fputs(const char* str, FILE* stream)
{
...
int __PROBE__putc(int character, FILE* stream)
{
...
int __PROBE__ungetc(int character, FILE* stream)
{
...
size_t __PROBE__fread(void* ptr, size_t size, size_t count, FILE* stream)
{
...
size_t __PROBE__fwrite(const void* ptr, size_t size, size_t count, FILE* stream)
{
...
// *********************************************************
int __PROBE__fprintf(FILE* stream, const char* format, ...)
{
...
int __PROBE__fscanf(FILE* stream, const char* format, ...)
{
...
int __PROBE__printf(const char* format, ...)
{
...
int __PROBE__scanf(const char* format, ...)
{
...
#if !defined(DA_DEBUG_LOG) && !defined(PRINT_STDOUT)
int __PROBE__puts(const char* str)
{
...
void __PROBE__setbuf(FILE* stream, char* buf)
{
...
void __PROBE__setbuffer(FILE* stream, char* buf, size_t size)
{
...
void __PROBE__setlinebuf(FILE* stream)
{
...
int __PROBE__setvbuf(FILE* stream, char* buf, int mode, size_t size)
{
