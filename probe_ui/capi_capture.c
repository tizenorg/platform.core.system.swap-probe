...
Evas_Object *__PROBE__elm_win_add(Evas_Object *parent, const char* name, Elm_Win_Type type)
{
...
Evas_Object *__PROBE__elm_controlbar_add (Evas_Object *parent)
{
...
Evas_Object *__PROBE__elm_naviframe_add(Evas_Object *parent)
{
...
Evas_Object *__PROBE__elm_pager_add(Evas_Object *parent)
{
